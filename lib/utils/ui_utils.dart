...
class UiUtils {
  ...
  static Color getAdaptiveTextColor(Color color) {
    ...
    return Color.fromARGB(color.alpha.toInt(), d, d, d);
  }
...
extension ColorUtils on Color {
  int toInt() {
    final a = (this.alpha * 255).toInt();
    final r = (this.red * 255).toInt();
    final g = (this.green * 255).toInt();
    final b = (this.blue * 255).toInt();
