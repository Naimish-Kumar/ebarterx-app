...
import 'package:eBarterx/ui/screens/subscription/payment_gatways.dart';
...
import 'package:eBarterx/utils/payment/gateaways/payment_webview.dart';
                  ...
                  child: BlocListener<AssignFreePackageCubit,
                      ...
                      child: UiUtils.buildButton(context, onPressed: () {
                        UiUtils.checkUser(
                          ...
                          buttonColor: widget
                                  .modelList[selectedIndex!].isActive!
                              ? context.color.textLightColor.withOpacity(0.01)
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: widget.modelList[index].isActive! ||
                              index == selectedIndex
                          ? context.color.territoryColor
                          : context.color.textDefaultColor.withOpacity(0.13),
                      width: 1.5)),
